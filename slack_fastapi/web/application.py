...
from slack_fastapi.web.api.dummy.views import router as dummy_router
from slack_fastapi.web.api.echo.views import router as echo_router
...
def get_app() -> FastAPI:
    ...
    async def log_requests(request: Request, call_next: Any) -> Response:
        ...
        :param call_next: Callable for the next item in the middleware chain.
